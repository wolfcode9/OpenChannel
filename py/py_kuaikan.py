...
class Spider(Spider):  # 元类 默认的元类 type
    ...
    def homeVideoContent(self):
        rsp = self.fetch("https://kuaikan-api.com/api.php/provide/vod/from/kuaikan?do=homeVideoContent")
    ...
    def categoryContent(self,tid,pg,filter,extend):
        ...
        url = 'https://kuaikan-api.com/api.php/provide/vod/from/kuaikan?do=categoryContent&tid={0}&page={1}&{2}'.format(tid, pg,params)
        rsp = self.fetch(url)
        alists = json.loads(rsp.text)
        alist = alists['list']
    ...
    def detailContent(self,array):
        tid = array[0]
        url = 'https://kuaikan-api.com/api.php/provide/vod/from/kuaikan?do=detailContent&id={0}'.format(tid)
        rsp = self.fetch(url)
        alists = json.loads(rsp.text)
        vod = alists['vod']
        result = {
    ...
    def searchContent(self,key,quick):
        url = 'https://kuaikan-api.com/api.php/provide/vod/from/kuaikan?do=searchContent&wd={0}'.format(key)
        rsp = self.fetch(url)
        alists = json.loads(rsp.text)
        list = alists['list']
        result = {
